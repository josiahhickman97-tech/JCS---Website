...
$IndustryPages = @(
  @{
    ...
    desc = "Reduce shrinkage, secure back doors, and protect inventory with retail video, access control, and after-hours AI alerts. Mississippi stores and commercial sites."
    canonical = "https://jcssafetysystems.com/industries/retail-commercial"
    image = "/assets/retail-store.jpg"
    keywords = "retail security cameras Mississippi, commercial access control, store loss prevention, shoplifting cameras Mississippi"
    ...
    sidebarText = "Free walkthrough for retail and commercial sites across Mississippi."
  ...
  @{
    ...
    desc = "School security cameras, vestibule visibility, and door access schedules for K-12 campuses in Mississippi. Designed for staff who run the building every day."
    canonical = "https://jcssafetysystems.com/industries/k-12-education"
    image = "/assets/school-campus.jpg"
    keywords = "school security cameras Mississippi, K-12 access control, campus video surveillance, school vestibule security Mississippi"
  ...
  @{
    ...
    desc = "Multi-building campus video, residence hall access, parking awareness, and fiber infrastructure for colleges and universities in Mississippi."
    ...
    sidebarTitle = "Protect your campus"
    sidebarText = "Assessments for colleges, universities, and satellite sites across Mississippi."
  ...
  @{
    ...
    desc = "Evidence-ready video, LPR cameras, audit-ready access, and reliable support for law enforcement and corrections facilities in Mississippi."
  ...
  @{
    ...
    desc = "Outdoor-rated video, gate access, and long-run fiber for industrial yards, warehouses, docks, and plants across Mississippi."
